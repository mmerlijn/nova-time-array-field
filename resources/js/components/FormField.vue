<template>
    <default-field :field="field" :errors="errors">
        <template slot="field">
            ...
            <button class="bg-primary hover:bg-primary-dark font-bold text-white p-2 rounded focus:shadow-outline" @click.prevent="[van='0:00',tot='23:59',add]" tabindex="5">Hele dag</button>
            <button class="bg-primary hover:bg-primary-dark font-bold text-white p-2 rounded focus:shadow-outline" @click.prevent="this.value=[]" tabindex="6">Wis</button>
