...
/* harmony export */ });
/* harmony import */ var _TimeArray__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../TimeArray */ "./resources/js/TimeArray.js");

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  props: ['index', 'resource', 'resourceName', 'resourceId', 'field'],
  data: function data() {
    return {
      timeArray: new _TimeArray__WEBPACK_IMPORTED_MODULE_0__["default"]()
    };
  },
...
/* harmony import */ var _TimeArray__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../TimeArray */ "./resources/js/TimeArray.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      van: '',
      tot: '',
      timeArray: new _TimeArray__WEBPACK_IMPORTED_MODULE_1__["default"]()
    };
  },
  watch: {
    timeArray: {
  ...
  methods: {
    ...
    time2int: function time2int(val) {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_PanelItem, {
    ...
    value: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.timeArray.humanReadable()), 1 /* TEXT */)];
    }),
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_DefaultField, {
    ...
    field: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
        "class": "form-control form-input form-input-bordered w-20",
        type: "text",
        "onUpdate:modelValue": _cache[0] || (_cache[0] = function ($event) {
          return $data.van = $event;
        }),
        ref: "van",
        placeholder: "08:00",
        onChange: _cache[1] || (_cache[1] = function ($event) {
          return $data.van = $options.toTime($data.van);
        }),
        tabindex: "1"
      }, null, 544 /* HYDRATE_EVENTS, NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.van]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
        "class": "form-control form-input form-input-bordered w-20",
        type: "text",
        "onUpdate:modelValue": _cache[2] || (_cache[2] = function ($event) {
          return $data.tot = $event;
        }),
        placeholder: "17:00",
        onChange: _cache[3] || (_cache[3] = function ($event) {
          return $data.tot = $options.toTime($data.tot);
        }),
        tabindex: "2"
      }, null, 544 /* HYDRATE_EVENTS, NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.tot]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
        type: "button",
        ...
        onClick: _cache[5] || (_cache[5] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function () {
          return $options.sub && $options.sub.apply($options, arguments);
        }, ["prevent"])),
        tabindex: "4"
      }, " - "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
        type: "button",
        ...
        onClick: _cache[6] || (_cache[6] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function () {
          return $options.day && $options.day.apply($options, arguments);
        }, ["prevent"])),
        tabindex: "5"
      }, " Hele dag "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
        type: "button",
        "class": "shadow relative bg-primary-500 hover:bg-primary-400 text-white dark:text-gray-900 cursor-pointer rounded text-sm font-bold focus:outline-none focus:ring ring-primary-200 dark:ring-gray-600 inline-flex items-center justify-center h-9 px-3 shadow relative bg-primary-500 hover:bg-primary-400 text-white dark:text-gray-900",
        onClick: _cache[7] || (_cache[7] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function () {
          return $options.trash && $options.trash.apply($options, arguments);
        }, ["prevent"])),
        tabindex: "6"
      }, " Wis ")]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_2, "Op tijden: " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.timeArray.humanReadable()), 1 /* TEXT */)];
    }),
...
function TimeArray() {
  ...
  this.array = [];
  if (Array.isArray(array[0])) for (var _i = 0; _i < array.length; _i++) {
    this.add(array[_i]);
  } else {
    this.add(array);
  }
  ...
  if (Array.isArray(array[0])) {
    ...
    if (this.valid(array)) {
      ...
      for (i = 0; i < this.array.length; i++) {
        var s = this.array[i][0];
        var e = this.array[i][1];
        //voorliggend
        //blok     --------
        //sit 1  -----
        //sit 2    -----
...
TimeArray.prototype.dump = function () {
  for (var _i4 = 0; _i4 < this.array.length; _i4++) {
    console.log(this.array[_i4][0] + '-' + this.array[_i4][1]);
  }
};
TimeArray.prototype.compact = function () {
  ...
  for (var _i5 = 1; _i5 < this.array.length; _i5++) {
    var s_ = this.array[_i5 - 1][0];
    var e_ = this.array[_i5 - 1][1];
    var s = this.array[_i5][0];
    var e = this.array[_i5][1];
    if (s_ === s) {
      if (e_ > e) {
        this.array.splice(_i5, 1);
      } else {
        this.array.splice(_i5 - 1, 1);
      }
      break;
    } else if (e_ >= s) {
      if (e_ > e) {
        this.array[_i5 - 1] = [s_, e_];
        this.array.splice(_i5, 1);
      } else {
        this.array[_i5 - 1] = [s_, e];
        this.array.splice(_i5, 1);
      }
      break;
    }
...
TimeArray.prototype.humanReadable = function () {
  var readable = [];
  for (var _i6 = 0; _i6 < this.array.length; _i6++) {
    readable.push(this.int2Time(this.array[_i6][0]) + '-' + this.int2Time(this.array[_i6][1]));
  }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TimeArray);
...
Nova.booting(function (app, store) {
  app.component('index-nova-time-array-field', _components_IndexField__WEBPACK_IMPORTED_MODULE_0__["default"]);
  app.component('detail-nova-time-array-field', _components_DetailField__WEBPACK_IMPORTED_MODULE_1__["default"]);
  app.component('form-nova-time-array-field', _components_FormField__WEBPACK_IMPORTED_MODULE_2__["default"]);
});
...
/* harmony import */ var K_laravel_projects_laravel9_package_test_nova_components_NovaTimeArrayField_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,K_laravel_projects_laravel9_package_test_nova_components_NovaTimeArrayField_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_DetailField_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_DetailField_vue_vue_type_template_id_0224618e__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/DetailField.vue"]])
/* hot reload */
if (false) {}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmmerlijn_nova_time_array_field"] = self["webpackChunkmmerlijn_nova_time_array_field"] || [];
